// VideoDetailsReadableClean.jsx – fully readable version with spaced sections and comments
...
function VideoDetails() {
  ...
  const handleTranscriptSearch = async () => {
    try {
      ...
      setSearchResults([...res.data].sort((a, b) => b.score - a.score));
    } catch (err) {
      console.error(err);
    ...
    <div className="video-details-page">
      ...
      <section className="video-actions">
        ...
        <button className="action-btn" onClick={loadTimeline} disabled={timelineLoading}>
          {timelineLoading && <span className="spinner" />}Timeline
        </button>
        <button className="action-btn" onClick={loadHighlights} disabled={highlightsLoading}>
          {highlightsLoading && <span className="spinner" />}Highlights
        </button>
        ...
        <section className="panel fade-in">
          ...
          <div className="question-row">
            ...
            <button className="action-btn" onClick={handleVisualSearch} disabled={visualLoading}>
              {visualLoading && <span className="spinner" />}Search
            </button>
          </div>
          <div className="results-container">
